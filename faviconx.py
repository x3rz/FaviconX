...
json_data = '''{
  ...
  "467483715": "FotiExtender and FortiADC",
...
command_template = 'shodan search http.favicon.hash:{key} org:"{org_name}" --fields ip_str,port,org --separator ,'

for key, value in data.items():
    print ("\033[1;34;40m" + "For Service " + str(value) + "\033[0m")
    command = command_template.format(key=key, org_name=sys.argv[1])
    os.system(command)
